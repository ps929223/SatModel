'''
VBD Density NC 자료를 읽어서 Daily 가시화
2021.09.01
Auth: Hokun Jeon
...
# 호군 로컬 PC
path_NC='E:/20_Product/VBD/NC/DensityMonthly'
path_Lib = 'D:/programming/SatModel/Lib'
sys.path.append(path_Lib)


def read_month_NC(path_file, map_res1, grid_res1):
    # path_file='E:/20_Product/VBD/NC/DensityMonthly/2018/ShipDensity_Donghae_2018-02_0.05.nc'
    # map_res1='h'
    # grid_res1=1
    import Map
